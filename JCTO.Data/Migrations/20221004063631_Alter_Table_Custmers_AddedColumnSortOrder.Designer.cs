...
namespace JCTO.Data.Migrations
{
    ...
    [Migration("20221004063631_Alter_Table_Custmers_AddedColumnSortOrder")]
    partial class Alter_Table_Custmers_AddedColumnSortOrder
    {
            ...
            modelBuilder.Entity("JCTO.Domain.Entities.Entry", b =>
                {
                    ...
                    b.Property<Guid?>("RebondFromEntryTxnId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("JCTO.Domain.Entities.Entry", b =>
                {
                    ...
                    b.HasOne("JCTO.Domain.Entities.EntryTransaction", "RebondFromEntryTxn")
                        .WithOne("RebondToEntry")
                        .HasForeignKey("JCTO.Domain.Entities.Entry", "RebondFromEntryTxnId");
                    ...
                    b.Navigation("RebondFromEntryTxn");
                });
